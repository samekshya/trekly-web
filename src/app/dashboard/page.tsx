...
//     try {
//       await api.get("/auth/me"); // cookie is sent automatically because withCredentials:true
//     } catch {
...
//           }}
//         >
//           <StatCard title="Saved Treks" value="0" note="Will connect in Sprint-2" />
//           <StatCard title="Planned Trips" value="0" note="UI placeholder" />
//           <StatCard title="Recent Searches" value="0" note="UI placeholder" />
//           <StatCard title="Profile Status" value="Incomplete" note="UI placeholder" />
//         </div>
